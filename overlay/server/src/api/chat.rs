...
impl ChatResponder {
    ...
    fn ensure_headers(&mut self) {
        ...
        // SSE stream established with 200 — audit records the chat as served.
...
fn today_utc_for_chat() -> String {
    ...
    let secs = SystemTime::now()
        ...
        .unwrap_or(0);
    // Shares the civil-from-days implementation with the audit module.
    crate::audit::utc_date(secs)
}
