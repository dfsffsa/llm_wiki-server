...
use crate::api::{self, err, ok, normalize_path, parse_query, resolve_project};
...
pub fn handle_files(state: &ServerState, project_id: &str, query: &str) -> api::ApiResponse {
...
pub fn safe_join(project_path: &str, rel: &str) -> Result<PathBuf, String> {
