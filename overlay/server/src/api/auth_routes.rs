...
fn today_utc() -> String {
    // YYYY-MM-DD in UTC. Shares the civil-from-days implementation with the
    // audit module (no chrono dependency anywhere).
    crate::audit::utc_date(now_secs() as u64)
}
