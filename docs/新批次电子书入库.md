...
## 8. 并行入库
`INGEST_WORKERS=4 LLM_WIKI_PROJECT="\/home/ab/overseas-github/llm_wiki_projects/<project>" LLM_WIKI_CONFIG=overlay/config/server.local.json ./scripts/ingest-parallel.sh`
